...
const questions = [
    ...
    "카페나 공공장소에서 주변이 시끄러우면  집중하기 힘들다.",
    "사람이 많은 명절이나 회식 자리에서는 쉽게 지친다.",
    ...
    "업무나 발표 중 누군가가 평가하고 있다는 생각이 들면 긴장한다.",
    "조용한 환경에서 더 잘 집중할 수 있다.",
    "가족이나 친구와의 만남 후에는 혼자만의 시간이 필요하다.",
    "복잡한 쇼핑몰이나 사람이 붐비는 장소에서는 금방 피로감을 느낀다.",
